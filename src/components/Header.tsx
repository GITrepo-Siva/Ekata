...
const Header: React.FC<HeaderProps> = ({ onRefresh, onDataUploaded, lastUpdated }) => {
  return (
    <header className="bg-brand-cream shadow-md p-4 sticky top-0 z-10">
      <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <DataUploader onDataUploaded={onDataUploaded} />
          <button 
            onClick={onRefresh}
      ...
      {lastUpdated && (
        <div className="container mx-auto text-right text-xs text-gray-500 mt-1 pr-1">
