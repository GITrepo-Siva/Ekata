  ...
  const schema = {
    ...
    items: {
      ...
      properties: {
        ...
        arabica_price: { type: Type.NUMBER, description: "Price of Arabica coffee in USD per pound. Null if unavailable." },
        robusta_price: { type: Type.NUMBER, description: "Price of Robusta coffee in USD per pound. Null if unavailable." },
      },
